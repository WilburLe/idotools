...
public class LatLngUtility {
     ...
     *
     */
    public static double distanceKm(LatLng point1, LatLng point2) {
        return Math.round(distanceM(point1, point2) / 10d) / 100d;
    }
    ...
    public static double distanceM(LatLng point1, LatLng point2) {
        ...
        return distanceM(lat1, lng1, lat2, lng2);
    }
