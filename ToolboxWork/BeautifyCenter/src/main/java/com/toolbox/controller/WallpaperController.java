...
import com.toolbox.common.SystemEnum;
...
public class WallpaperController {
    ...
    public ModelAndView uploadpage() {
        JSONObject tags = tagEditService.findTagByName(SystemEnum.wallpaper.getTablename());
        return new ModelAndView("upload").addObject("tablename", SystemEnum.wallpaper.getTablename()).addObject("tags", tags);
    }
