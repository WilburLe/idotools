	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview">
				...
				<ul class="treeview-menu">
					<li><a href="javascript: loadData('<%=WebUtility.getBasePath(request) %>hot/rank/internal')">国内</a></li>
					<li><a href="javascript: loadData('<%=WebUtility.getBasePath(request) %>hot/rank/googleplay')">GooglePlay</a></li>
				</ul>
			</li>
			<li class="treeview">
				<a href="#">
